    ...
    fetch(`https://www.cheapshark.com/api/1.0/deals?pageSize=5&sortBy=Savings`)
        ...
        .then((res) => {
            ...
            for (let i=0; i<5; i++) {
                ...
                else if (dratings > 5.0) {
                    cell_deal.style.backgroundColor = "green";
                    cell_deal.style.color = "white";
                }
                else if (dratings == 5.0){
                    cell_deal.style.backgroundColor = "yellow";
                    cell_deal.style.color = "white";
                }
...
function sorted_games(upper, lower, sort) {
    ...
    let search_prompt = "https://www.cheapshark.com/api/1.0/deals?&pageSize=25";
